...
def register_user(username, email, password):
    ...
    # 3. Hash password and insert user (unverified)
    ...
    # 4. Generate and store a 6-digit verification code (expires in 10 min)
...
def request_password_reset(email, device_info):
    ...
    <div style="background:#0a0a0a;padding:40px 20px;font-family:'Courier New',monospace;color:#f5f5f5;max-width:520px;margin:0 auto;border-radius:12px;border:1px solid #1a1a1a;">
      ...
      <p style="color:#333;font-size:10px;text-align:center;">This code will expire automatically. Bin Buddy will never ask for your password via email.</p>
    </div>
    """
